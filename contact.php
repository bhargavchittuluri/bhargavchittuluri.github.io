...
try {
    ...
    $mail->Username   = 'bhargavchittuluri@gmail.com';                     //SMTP username
    $mail->Password   = 'Your ID APP password';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
    $mail->setFrom('bhargavchittuluri@gmail.com', 'Email Enquiry');
    $mail->addAddress('bhargavchittuluri@gmail.com', 'Email Enquiry');     //Add a recipient
